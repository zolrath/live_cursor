defmodule LiveCursorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveCursorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveCursorWeb.Gettext, "errors", msg, opts)
    end
  end
